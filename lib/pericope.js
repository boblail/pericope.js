...
Pericope = function () {
  ...
  Pericope.parse = function (text) {
    var book, originalString, pericope, ranges, ref, ref1;
    ref1 = (ref = Pericope.matchOne(text)) != null ? ref : {}, originalString = ref1.originalString, book = ref1.book, ranges = ref1.ranges;
    if (!(book && ranges)) {
      return null;
    }
  ...
  function Pericope(book1, ranges1) {
    this.book = book1;
    this.ranges = ranges1;
  ...
  Pericope.prototype.wellFormattedReference = function (options) {
    var alwaysPrintVerseRange, chapterListSeparator, chapterRangeSeparator, i, j, maxChapter, maxVerse, minChapter, minVerse, range, recentChapter, ref, ref1, ref2, ref3, ref4, ref5, s, verseListSeparator, verseRangeSeparator;
    if (options == null) {
      options = {};
    }
    recentChapter = null;
    ...
    verseRangeSeparator = (ref = options.verseRangeSeparator) != null ? ref : "–";
    chapterRangeSeparator = (ref1 = options.chapterRangeSeparator) != null ? ref1 : "—";
    verseListSeparator = (ref2 = options.verseListSeparator) != null ? ref2 : ", ";
    chapterListSeparator = (ref3 = options.chapterListSeparator) != null ? ref3 : "; ";
    alwaysPrintVerseRange = (ref4 = options.alwaysPrintVerseRange) != null ? ref4 : false;
    s = "";
    for (i = j = 0, ref5 = this.ranges.length; 0 <= ref5 ? j < ref5 : j > ref5; i = 0 <= ref5 ? ++j : --j) {
      range = this.ranges[i];
  ...
  Pericope.matchAll = function (text, callback) {
    ...
    results = [];
    if (callback == null) {
      callback = function callback(attributes) {
  ...
  Pericope.normalizeReference = function (reference) {
    var j, len, ref, ref1, regex, replacement;
    ref = this.REFERENCE_NORMALIZATIONS;
    for (j = 0, len = ref.length; j < len; j++) {
      ref1 = ref[j], regex = ref1[0], replacement = ref1[1];
  ...
  Pericope.parseRanges = function (book, ranges) {
    var chapterRange, d, j, len, lowerChapterAndVerse, range, recentChapter, results1, upperChapterAndVerse;
    recentChapter = null;
    ...
    for (j = 0, len = ranges.length; j < len; j++) {
      ...
      lowerChapterAndVerse[1] = this.toValidVerse.apply(this, [book].concat(slice.call(lowerChapterAndVerse)));
      ...
      upperChapterAndVerse[1] = this.toValidVerse.apply(this, [book].concat(slice.call(upperChapterAndVerse)));
      recentChapter = upperChapterAndVerse[0];
      results1.push(new this.Range(this.getId.apply(this, [book].concat(slice.call(lowerChapterAndVerse))), this.getId.apply(this, [book].concat(slice.call(upperChapterAndVerse)))));
    }
    return results1;
  };
  ...
  Pericope.REFERENCE_NORMALIZATIONS = [[/^\d+/g, ''], [/(\d+)[".](\d+)/g, '$1:$2'], [/[–—]/g, '-'], [/[^0-9,:;\-–—]/g, '']];
